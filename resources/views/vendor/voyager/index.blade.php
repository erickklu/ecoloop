...
<div class="page-content">
    ...
    <div style="padding-left:20px;" class="tutorial">
        ...
        <p>A continuación te presentaremos una guia rapida de uso del panel de administración y de cómo utilizar las
            diferentes secciones:</p>

        <div class="entry-tutorial"
            style="border:solid 1px #D6D6D6; border-radius:8px; padding-left:10px; padding-right:10px; margin-top:10px; ">
            <h2>1. Publicaciones</h2>
            <p>En esta sección puedes ver, editar y eliminar las publicaciones que has creado. Navega a "Publicaciones"
                en
                el
        ...
        <div class="requested-tutorial"
            style="border:solid 1px #D6D6D6; border-radius:8px; padding-left:10px; padding-right:10px; margin-top:20px; ">
            <h2>2. Peticiones</h2>
            <p>En "Peticiones", puedes ver las solicitudes realizadas por otros usuarios a tus publicaciones. También
                puedes
                ver
